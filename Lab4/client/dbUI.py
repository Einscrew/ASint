                        ...
                        if len(l)==1:
                                ...
                                if command=='QUIT':
                                        ...
                                        if len(processed_line) ==3:
                                                ...
                                                self.db[randint(0,len(db))].addBook(processed_line[0], processed_line[1], int(processed_line[2]))
                                elif command == 'SHOW':
                                        l = input('Insert id :\n')
                                        processed_line = l.split()
                                        ...
                                        if len(processed_line) ==1:
                                                for d in self.db:
                                                    b = d.showBook(int(processed_line[0]))
                                                    print (b)
                                elif command == 'LISTALL':
                                        b_list = list()
                                        for d in self.db:
                                                print("[querying:",d,"]")
                                                b_list.append(d.listAllBooks())
                                        for b in b_list:
                                                print(b)
                                        ...
                                        if len(processed_line) ==1:
                                                b_list = list()
                                                for d in self.db:
                                                    b_list.append(d.listBooksAuthor(processed_line[0]))
                                                for b in b_list:
                                                        print(b)
                                        ...
                                        if len(processed_line) ==1:
                                                b_list = list()
                                                for d in self.db:
                                                    b_list.append(d.listBooksYear(int(processed_line[0])))
                                                for b in b_list:
                                                        print(b)
                                elif command == 'LISTYEAR':
                                        exit = True
